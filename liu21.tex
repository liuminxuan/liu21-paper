...
\begin{enumerate}[]
    \item vehicle is approaching the merge point. %1
    \item no vehicle is crossing the merge point and whole system is in Fully-prioritized state. %2
    \item vehicle crossed the merge point. %3
    \item number of through lane vehicle equals or greater than one explicit number and no vehicle is crossing the merge point.  %4
    \item whole system is in Fair state and through lane vehicle's turn and no vehicle is crossing the merge point. %5
    \item whole system is in Fair state and non-through lane vehicle's turn. %6
    \item whole system is not in Fair state. %7
    \item whole system is in Fair state and through lane vehicle's turn and no vehicle is crossing the merge point. %8
\end{enumerate}
...
\begin{enumerate}
    \item vehicle is approaching the merge point. %1
    \item through lane vehicle is approaching the merge point and whole system is not in Fair state. %2
    \item no vehicle on through lane is approaching the merge point and whole system is not in Fair state and no vehicle is crossing the merge point. %3
    \item vehicle crossed the merge point. %4
    \item no vehicle on through lane is approaching the merge point and whole system is not in Fair state and no vehicle is crossing the merge point. %5
    \item whole system is in Semi-prioritized state and no vehicle is crossing the merge point. %6
    \item whole system is in Fair state and non-through lane vehicle's turn and no vehicle is crossing the merge point. %7
    \item whole system is in Fair state and through lane vehicle's turn. %8
    \item whole system is not in Fair state. %9
    \item whole system is in Fair state and through lane vehicle's turn. %10
    \item whole system is in Fair state and non-through lane vehicle's turn and no vehicle is crossing the merge point. %11
    \item whole system is in Fair state and non-through lane vehicle's turn and no vehicle is crossing the merge point. %12
\end{enumerate}
...
%\noindent Condition 2 of the non-through lane is specified by Maude as follow:
\begin{footnotesize}
\begin{verbatim}
crl [full_N_stop] : 
{(gstat: nFin) 
...
%\noindent Condition 3 and 5 explain how vehicle moves from approaching status to crossing status in Fully-prioritized state.
%They are specified as follows by Maude:

...
\begin{itemize}
    ...
    \item (\verb!switch:!$c$\verb!,!$semi$\verb!,!$fair$\verb!,!$nonthrough$\verb!,!$nthrough$) - $c$ receives one of the following two values: \verb!vehicleCrossing! indicating there is not any vehicle crossing the merge point, or \verb!noVehicleCrossing! indicating there exists a vehicle crossing the merge point.

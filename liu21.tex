...
We also allows vehicles to make a query to the controller of the merge point at any time.
...
The experiments with six vehicles participarting in shows that the protocol enjoys the mutual exclusion property. 
